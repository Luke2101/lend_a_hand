 ...
 * /request:
 *   get:
 *     summary: Retrieve one or more service requests by ID
 *     description: Returns detailed information for one or more service requests.
 *       Supports multiple request IDs via repeated query parameters (e.g. `?ids=12&ids=13&ids=14`).
 *     tags:
 *       - Requests
 *     parameters:
 *       - in: query
 *         name: ids
 *         required: true
 *         description: One or more request IDs to retrieve.
 *           Use multiple `ids` parameters to specify multiple requests.
 *         schema:
 *           type: array
 *           items:
 *             type: integer
 ...
 *     responses:
 *       200:
 *         description: Requests found and returned successfully.
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *       404:
 *         description: One or more requests were not found.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       400:
 *         description: Invalid query parameters (e.g., malformed IDs).
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                         type: string
 *       500:
 *         description: Internal server error while retrieving requests.
 */
router.get("/", validateQuery(idArrayQuerySchema), RequestController.get.bind(RequestController) as unknown as RequestHandler)
/**
 * @swagger
 * /request/nearby:
 *   get:
